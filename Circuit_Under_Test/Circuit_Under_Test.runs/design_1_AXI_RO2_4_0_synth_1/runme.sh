...
HD_PWD='C:/Tutorials/Vivado/parvez_ro_exp6/parvez_ro_exp6.runs/design_1_AXI_RO2_4_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI_RO2_4_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI_RO2_4_0.tcl
